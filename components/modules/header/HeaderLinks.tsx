      ...
      <li>
        {isAuth ? (
          ...
          <svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' fill='none' viewBox='0 0 20 20'>
            <path fill='#000' fill-rule='evenodd' d='M15.3 16.6a8.5 8.5 0 1 0-10.6 0 5.5 5.5 0 0 1 10.6 0Zm-1.3 1a4 4 0 0 0-8 0 8.5 8.5 0 0 0 8 0ZM10 20a10 10 0 1 0 0-20 10 10 0 0 0 0 20Zm0-10.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm0 1.5a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z' clip-rule='evenodd' />
          </svg>
        ) : (
