...
export const useCartAction = (isSizeTable = false) => {
  ...
  const existingItem = currentCartByAuth.find((item) => item.productId === product._id)
  ...
  const allCurrentCartItemCount = useMemo(() => currentCartItems.reduce((a, { count }) => a + +count, 0), [currentCartItems])
