...
export interface IGetParkhomenkoOfficesByCityFx {
  city: string
  lang: string
}

export interface IParkhomenkoAddressData {
...
export interface IPickupAddressItemProps {
  addressItem: IParkhomenkoAddressData
  handleSelectAddress: (arg0: IAddressBBox, arg1: IAddressPosition) => void
  handleChosenAddressData: (arg0: Partial<IParkhomenkoAddressData>) => void
}
